...
public class AirportGapAPITest {
    ...
    final String bearerToken = "QAwLha38pfS234BsssbuyTtf"; // Bearer токен
    ...
    public void createFavoriteAirport() {
        ...
        given()
                ...
                .when()
                .post(BASE_URL + "/favorites?airport_id=YBB") // YBG, YBC, YBB
                .then()
    ...
    public void deleteFavoriteAirport() {
        given()
                ...
                .when()
                .delete(BASE_URL + "/favorites/19369") // URL для видалення
                .then()
